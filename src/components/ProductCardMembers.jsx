...
// function ProductCardMembers({ product }) {
...
// export default ProductCardMembers;
...
function ProductCardMembers({ product }) {
  ...
  return (
    <Link
      to={`/product/${product.id}`}
      className="group min-w-0 w-full overflow-hidden rounded-2xl border border-white/10 bg-white/5 transition duration-300 hover:-translate-y-1 hover:border-g3-light-purple hover:shadow-xl"
    >
      {/* Image Container */}
      ...
      <div className="p-4">
        <div className="mb-2 flex min-w-0 items-start justify-between gap-2">
          <h3 className="min-w-0 line-clamp-2 break-words text-sm font-bold text-white">
            {product.name}
          </h3>
