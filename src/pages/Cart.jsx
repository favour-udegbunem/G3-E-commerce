        ...
        <section className="mx-auto flex min-h-[520px] max-w-7xl items-center justify-center px-4 py-16 sm:px-6 lg:px-8">
          <div className="max-w-md text-center">
            ...
            <p className="mt-3 text-sm leading-6 text-white/55">
              Nothing here yet. Explore G3 Lounge and find something
              special to add to your box.
            </p>
                  ...
                  {cartItems.map((item) => (
                    ...
                    >
                      <div className="flex gap-4 sm:gap-6">
                        ...
                        <Link
                          to={`/product/${item.id}`}
                          className="h-24 w-24 shrink-0 overflow-hidden rounded-2xl bg-g3-light-pink sm:h-32 sm:w-32"
                        >
                          <img
                            src={item.image}
                            alt={item.name}
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="flex items-start justify-between gap-3">
                            <div>
                              <Link
                                to={`/product/${item.id}`}
                                className="text-base font-black text-white transition hover:text-g3-pink sm:text-lg"
                              >
                                {item.name}
                              </Link>
                            ...
                            <button
                              ...
                              className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full text-white/45 transition hover:bg-red-50 hover:text-red-500"
                          ...
                          <div className="mt-5 flex flex-wrap items-center justify-between gap-4">
                            ...
                            <div className="flex items-center rounded-full border border-white/15">
                              <button
                                ...
                                className="flex h-9 w-9 items-center justify-center rounded-full text-white transition hover:bg-g3-light-pink"
            ...
            <aside className="lg:sticky lg:top-28 lg:self-start">
              <div className="overflow-hidden rounded-3xl border border-white/10 bg-white/5">
                ...
                <div className="space-y-4 px-6 py-6">
                  ...
                  <Link
                    to="/checkout"
                    className="flex w-full items-center justify-center gap-2 rounded-full bg-g3-gold px-6 py-4 text-sm font-black text-white transition hover:bg-g3-pink"
                  >
                    Proceed to Checkout
                    <ArrowRight size={17} />
                  </Link>
                  ...
                  <div className="rounded-2xl bg-g3-light-pink/50 p-4">
                    <p className="text-xs leading-5 text-white">
                      💗 You can shop as a guest. An account is required when
                      you continue to checkout so your order can stay connected
                      to your G3 Lounge journey.
                    </p>
                  </div>
                </div>
              </div>
