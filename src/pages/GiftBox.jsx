...
function GiftBox() {
  ...
  const addProduct = (product) => {
    // Welcome gift: only once, quantity locked at 1
    if (isWelcomeGiftItem(product)) {
      setSelectedProducts((current) => {
        if (current.some((item) => isWelcomeGiftItem(item))) {
          return current;
        }
        return [
          ...current,
  ...
  const increaseQuantity = (productId) => {
    setSelectedProducts((current) =>
      current.map((item) => {
        ...
        if (isWelcomeGiftItem(item)) return item; // locked
        return {
          ...item,
          quantity: item.quantity + 1,
        };
  ...
  const decreaseQuantity = (productId) => {
    setSelectedProducts((current) =>
      current
        .map((item) => {
          if (item.id !== productId) return item;
          if (isWelcomeGiftItem(item)) return item; // locked at 1
          return {
            ...item,
            quantity: item.quantity - 1,
          };
            ...
            <div className="mx-auto max-w-6xl px-5 pb-9 pt-8 sm:px-8 sm:pb-10 sm:pt-10 lg:px-10">
              ...
              <div className="mt-6 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-2 max-w-xl text-sm leading-6 text-white/60">
                    Put together something personal for someone special.
                  </p>
                </div>
              </div>
            </div>
                ...
                {[1, 2, 3, 4, 5].map((number) => (
                  <div key={number} className="flex flex-1 items-center">
                    ...
                    {number < 5 && (
                      <div
                        className={`mx-2 h-0.5 flex-1 transition ${
                          step > number ? "bg-g3-purple" : "bg-gray-100"
                        }`}
                      />
                    )}
                  </div>
            ...
            <div className="grid gap-6 xl:grid-cols-[1fr_350px]">
                ...
                {step === 1 && (
                  <div>
                    <div className="mb-7">
                      ...
                      <p className="mt-2 text-sm text-white/55">
                        Tell us who this little surprise is meant for.
                      </p>
                    </div>
                ...
                {step === 4 && (
                  <div>
                    <div className="mb-7">
                      ...
                      <p className="mt-2 text-sm text-white/55">
                        A few words can make the gift feel even more personal.
                      </p>
                    </div>
                    ...
                    <textarea
                      ...
                      rows={7}
                      placeholder="Write something thoughtful..."
                      className="w-full resize-none rounded-2xl border border-white/15 bg-white/5 p-5 text-sm text-white outline-none transition placeholder:text-white/45 focus:border-g3-light-purple focus:bg-white/10 focus:ring-4 focus:ring-g3-light-purple/10"
                    />
                      ...
                      <div className="mt-4 space-y-3">
                        {packagingOptions.map((option) => (
                          <button
                            key={option.name}
                            type="button"
                            onClick={() => setPackaging(option.name)}
                            className={`flex w-full items-center justify-between rounded-2xl border p-4 text-left transition ${
                              packaging === option.name
                                ? "border-g3-pink bg-g3-light-pink"
                                : "border-white/10 hover:border-g3-light-purple"
                ...
                {step === 5 && (
                  <div>
                    ...
                    <div className="rounded-3xl bg-g3-light-pink p-6">
                      ...
                      <div className="mt-6">
                        <div className="mb-3 flex items-center justify-between">
                          <h3 className="text-sm font-black text-white">Items</h3>
                          <span className="text-xs font-bold text-white/45">
                        ...
                        <div className="space-y-3">
                          {selectedProducts.map((product) => (
                            ...
                            >
                              ...
                              {/* No +/- for welcome gift */}
                              {isWelcomeGiftItem(product) ? (
                                <span className="rounded-full bg-g3-gold/20 px-3 py-1 text-[10px] font-bold text-g3-gold">
                                  Qty 1
                                </span>
                              ) : (
                                <div className="flex items-center gap-2">
                                  <button
                                    ...
                                    className="flex h-7 w-7 items-center justify-center rounded-full bg-white/10 text-white/65"
                                  >
                                    <Minus size={13} />
                                  </button>
                              ...
                              <button
                                ...
                                className="ml-1 text-white/40 transition hover:text-red-500"
                                aria-label={`Remove ${product.name}`}
                              >
                                <Trash2 size={17} />
                              </button>
              ...
              <aside className="h-fit rounded-3xl border border-white/10 bg-white/5 p-6 xl:sticky xl:top-6">
                ...
                <div className="mt-6 space-y-4 border-t border-white/10 pt-5">
                  ...
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-white/55">Occasion</span>
                    <span className="font-bold text-white">
                      {occasion || "Not selected"}
                    </span>
                  </div>
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-bold text-white">{packaging}</span>
                  </div>
                </div>
                ...
                <div className="mt-5 rounded-2xl bg-white/5 p-4">
                  <p className="text-xs leading-5 text-white/55">
                    Your gift box is currently a draft. You can review and save
                    it before adding it to your G3 Box.
                  </p>
                </div>
              </aside>
            </div>
