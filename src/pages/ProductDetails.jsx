      ...
      <section className="border-b border-white/10">
        <div className="mx-auto max-w-7xl px-4 py-5 sm:px-6 lg:px-8">
          <div className="flex flex-wrap items-center gap-2 text-sm">
            ...
            <span className="max-w-[220px] truncate font-semibold text-white sm:max-w-none">
              {product.name}
            </span>
          </div>
        </div>
        ...
        <div className="grid min-w-0 gap-8 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="min-w-0">
            <div className="relative overflow-hidden rounded-[2rem] bg-g3-light-pink">
              ...
              {product.newArrival && (
                <span className="absolute left-4 top-4 inline-flex items-center gap-1.5 rounded-full bg-g3-pink px-3 py-2 text-[10px] font-black uppercase tracking-wider text-white sm:left-5 sm:top-5 sm:px-4 sm:text-xs">
                  <Sparkles size={14} />
                  New Arrival
                </span>
              )}
              ...
              <button
                ...
                className={`absolute right-4 top-4 flex h-11 w-11 items-center justify-center rounded-full bg-white/5 shadow-lg transition sm:right-5 sm:top-5 ${
                  liked
                    ? "text-g3-pink"
                    : "text-white hover:text-g3-pink"
                }`}
          ...
          <div className="flex min-w-0 flex-col justify-center">
            ...
            <div className="mt-7 grid gap-3 sm:grid-cols-[1fr_auto]">
              <button
                type="button"
                onClick={handleAddToBox}
                className={`flex min-h-14 w-full items-center justify-center gap-2 rounded-full px-6 text-sm font-black transition ${
                  added
                    ? "bg-green-500 text-white"
                    : "bg-g3-purple text-white hover:bg-g3-pink"
                }`}
              ...
              <button
                type="button"
                onClick={handleBuyNow}
                className="min-h-14 w-full rounded-full bg-g3-gold px-7 text-sm font-black text-white transition hover:bg-g3-purple sm:w-auto"
              >
                Buy Now
              </button>
            </div>
            ...
            {/* BENEFITS */}
            <div className="mt-8 grid gap-5 border-t border-white/10 pt-7 sm:grid-cols-3 sm:gap-4">
              <div className="flex items-start gap-3">
                <Truck
                  size={20}
                  className="mt-0.5 shrink-0 text-g3-pink"
