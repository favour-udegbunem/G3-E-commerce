          ...
          >
            <div className="relative">
              ...
              <input
                ...
                className="h-14 w-full rounded-full border border-white/15 bg-[#0F001C] pl-12 pr-32 text-sm text-white/90 outline-none placeholder:text-white/45 focus:border-g3-light-purple focus:bg-white/5 focus:ring-4 focus:ring-g3-light-purple/20"
              />
            ...
            <button
              ...
              className={`rounded-full px-5 py-2.5 text-sm font-bold transition ${
                selectedCategory === "all"
                  ...
                  : "bg-white/10 text-white/55 hover:bg-g3-light-pink hover:text-g3-pink"
              }`}
            >
              All
            </button>
        ...
        <div className="flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="flex h-11 items-center gap-2 rounded-full border border-white/15 bg-white/5 px-4 text-sm font-bold text-white lg:hidden"
            >
            ...
            <div className="relative">
              <select
                ...
                className="h-11 appearance-none rounded-full border border-white/15 bg-transparent bg-g3-purple pl-4 pr-10 text-sm font-bold text-white outline-none focus:border-g3-light-purple"
              >
                <div className="bg-g3-purple">
      ...
      <section className="mx-auto max-w-7xl px-4 pb-16 sm:px-6 lg:px-8">
        <div className="overflow-hidden rounded-3xl bg-g3-purple px-6 py-10 sm:px-10">
          <div className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-center">
            ...
            <Link
              to="/box"
              className="inline-flex shrink-0 items-center gap-2 rounded-full bg-g3-gold px-6 py-3.5 text-sm font-black text-[#0F001C] transition hover:bg-g3-pink"
            >
              View My G3 Box
              <ArrowRight size={17} />
            </Link>
          ...
          <div className="absolute bottom-0 left-0 right-0 rounded-t-3xl bg-white/5 p-6 shadow-2xl">
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="flex h-9 w-9 items-center justify-center rounded-full bg-white/10 text-white/55"
              >
                <X size={18} />
              </button>
            </div>
